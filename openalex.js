...
(function() {
  ...
  function render(){
    ...
    var pills=allTypes.map(function(t){var m=TM[t],a=selTypes.indexOf(t)!==-1;return'<button onclick="window._oaNL.toggleT(this.dataset.type)" data-type="'+t+'" style="border:2px solid '+(a?m.color:'rgba(255,255,255,0.15)')+';background:'+(a?m.bg:'transparent')+';color:'+(a?m.color:'#94a3b8')+';border-radius:20px;padding:6px 16px;cursor:pointer;font-size:13px;font-weight:600;margin:0 8px 8px 0">'+m.label+'</button>';}).join('');
...
(function() {
  ...
  function render(){
    ...
    var pills=allTypes.map(function(t){var m=TM[t],active=selTypes.indexOf(t)!==-1;return'<button onclick="window._oaNL.toggleT(this.dataset.type)" data-type="'+t+'" style="border:2px solid '+(active?m.color:'rgba(255,255,255,0.15)')+';background:'+(active?m.bg:'transparent')+';color:'+(active?m.color:'#94a3b8')+';border-radius:20px;padding:6px 16px;cursor:pointer;font-size:13px;font-weight:600;margin:0 8px 8px 0">'+m.label+'</button>';}).join('');
