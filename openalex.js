/* openalex.js — OpenAlex column for NL Research CRM (hardcoded, no API calls) */
(function () {
  'use strict';
  ...
  /* Lookup: exact CRM name -> OpenAlex data ------------------------------- */
  var DB = {
  ...
  function addColumns(table) {
    ...
    tbody.querySelectorAll('tr.sub-row').forEach(function (row) {
      ...
      if (info) {
        ...
        var rorUrl = 'https://ror.org/' + info.ror;
        evTd.innerHTML = '<span class="oa-badge">Education \u00b7 NL</span><br>' +
          '<span style="color:#cbd5e1">' + info.works + ' works</span><br>' +
          '<a class="oa-badge oa-ror" href="' + rorUrl + '" target="_blank" title="ROR — persistent institutional ID">ROR \u2713</a>';
      } else {
